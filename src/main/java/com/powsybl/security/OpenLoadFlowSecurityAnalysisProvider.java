...
/**
 * This implementation uses the OpenLoadFlow implementation of the security analysis
 *
 * @author Mathieu BAGUE {@literal <mathieu.bague at rte-france.com>}
 */
public class OpenLoadFlowSecurityAnalysisProvider implements SecurityAnalysisProvider {
    ...
    public CompletableFuture<SecurityAnalysisResult> run(Network network, String variant, ContingenciesProvider provider, SecurityAnalysisParameters parameters, ComputationManager computationManager) {
        OpenSecurityAnalysisFactory factory = new OpenSecurityAnalysisFactory();
